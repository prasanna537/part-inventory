    ...
    return (
        <div className="bg-white min-h-screen pb-20 font-sans">
            ...
            <div className="flex justify-end mt-4 px-4">
                <div className="w-[300px] text-[11px] font-bold">
                    <div className="flex justify-between py-1 bg-[#A0D4EA] px-2 mb-0.5 border border-gray-300">
                        <span className="uppercase">Total Goods Value</span>
                        <span>400.00</span>
                    </div>
                    <div className="flex justify-between py-1 bg-[#FFCCAA] px-2 mb-0.5 border border-gray-300">
                    ...
                    <div className="flex justify-between py-1 bg-[#FFCCAA] px-2 border border-gray-300">
            ...
            <div className="flex justify-end mt-6 px-4">
                <button className="bg-[#008A5E] text-white text-[11px] px-10 py-1.5 font-bold uppercase transition-transform active:scale-95 shadow-md">
                    Verify the GRN
                </button>
            </div>
        </div>
